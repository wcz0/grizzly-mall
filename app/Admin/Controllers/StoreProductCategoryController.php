...
use App\Services\StoreProductCategoryService;

/**
 * @property StoreProductCategoryService $service
 */
class StoreProductCategoryController extends AdminController
{
    protected string $serviceName = StoreProductCategoryService::class;
