...
/**
 * @property UserBillService $service
 */
class UserBillController extends AdminController
{
    protected string $serviceName = UserBillService::class;
    ...
    public function list(): Page
    {
        $crud = $this->baseCRUD()
            ...
            ->columns([
				...
				TableColumn::make()->name('category')->label('Category'),
    ...
    public function form(): Form
    {
        return $this->baseForm()->body([
			...
			TextControl::make()->name('category')->label('Category'),
    ...
    public function detail(): Form
    {
        return $this->baseDetail()->body([
			...
			TextControl::make()->static()->name('category')->label('Category'),
